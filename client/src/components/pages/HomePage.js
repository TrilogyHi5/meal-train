    ...
    <div class="bg-fixed bg-bottom top-0 left-0 w-full h-full bg-cover bg-no-repeat"
      ...
      <div className="flex justify-center items-center">
        <img src={lifestyleImage}
          className="mx-auto mt-0 rounded-3xl"
      ...
      <div className="flex flex-col lg:flex-row mx-auto max-w-4xl px-4 my-8">
        <div className="flex-1 mr-6 rounded-3xl bg-green-100 opacity-80 px-2">
          ...
          <p className="mb-4">
            ...
            Thus, we have created a chat platform where you can always be in touch with our team of nutritionists.
          </p>
        </div>
      ...
      <div className="flex  flex-col-reverse lg:flex-row mx-auto max-w-4xl px-4 my-8">
        ...
        <div className="flex-1  rounded-3xl bg-green-100 opacity-80 px-2">
          ...
          <p className="mb-4">
            ...
            depending on the your progress, your nutritional plan.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row mx-auto max-w-4xl px-4 my-8">
        <div className="flex-1 mr-6 rounded-3xl bg-green-100 opacity-80 px-2">
          ...
          <p className="mb-4">
            ...
            so you also have access to a series of light workouts that you can do in the comfort of your home.
          </p>
        </div>
        <div className="flex-1">
            ...
            <div class="font-bold text-2xl mb-2">
              ...
              <div>
                <p>We generate your own personalized aliemntar plan, 
                  ...
                  Choose only what you are entitled to suits you or requests a consultation with our team of nutritionists to decide together.</p>
              </div>
            </div>
          </div>
            ...
            <div class="font-bold text-2xl mb-2">
              ...
              <div>
                <p>We are with you on your journey towards a healthier lifestyle. 
                  We know it's not always easy, so we're at your disposal whenever you need us, via WhatsApp</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white bg-opacity-70 rounded-2xl p-4">
              ...
              <div>
                <p>We do not aggressively restrict caloric intake and do not have a 
                  ...
                  Thus, we want to provide the body with all the necessary macro-nutrients and we favor a healthy weight loss that you can easily maintain over time.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white bg-opacity-70 rounded-2xl p-4">
              ...
              <div>
                <p>The food diary helps you build a healthy lifestyle and create habits Healthy. 
                  ...
                  gradually, you will be able to do healthier choices.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white bg-opacity-70 rounded-2xl p-4">
              ...
              <div>
                <p>We support sports and outdoor movement, 
                  ...
                  We have created a series of light workouts with exercises gentle to befriend sports and give you the opportunity to access them then when you want.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white bg-opacity-70 rounded-2xl p-4">
              ...
              <div>
                <p>Our food plans are based on natural, 
                  ...
                  But, we make sure you are in caloric deficit and you eat diversified throughout your remodeling process.</p>
              </div>
            </div>
          </div>
        </div>
