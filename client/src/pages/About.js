  ...
  return (
    <div class="bg-fixed top-0 left-0 w-full h-full bg-cover bg-no-repeat"
      ...
      <div className="relative isolate px-6 pt-2 lg:px-8">
        <div className="mt-20">
          <div className="relative bg-gray-200 bg-opacity-70 rounded-3xl p-2 mx-5 my-5">
            <h1 className="text-4xl font-bold text-center">
              More About Meal Train
            </h1>
            <p className="mt-2 text-lg rounded-2xl py-2 px-3 border-2 boreder-gray-600 text-base font-semibold text-gray-900 opacity-60 bg-green-100 my-2 inline-block mx-2">
            ...
            <p className="mt-2 text-lg rounded-2xl py-2 px-3 text-base font-semibold text-gray-900 opacity-50 bg-green-100 my-2 inline-block mx-2">
      ...
      <div className="py-24 sm:py-32 bg-green-300 bg-opacity-70 rounded-3xl p-2 mx-5">
        <div className="max-w-7xl gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
          <div className="max-w-2xl ">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl bg-gray-300 rounded-2xl p-4 opacity-80">Meet the Meal Train team!</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600 bg-gray-300 rounded-2xl p-4 opacity-80">
              We're just a bunch of regular people.
            </p>
          </div>
          <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2 bg-gray-300 rounded-2xl p-4 opacity-80 mt-4 mx-6">
